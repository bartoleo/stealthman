...
function simplegui:setlayout(ptype,px,py,pwidth,pheight,pfont,pcolor,phcolor)
  ...
  self.layout.fontheight = self.layout.font:getHeight( )
end
...
function simplegui:addelement(pname,ptype,pargs)
  ...
  _element.fontheight=_element.font:getHeight( )
...
function simplegui:clear()
  ...
  self.layout={type="down",x=0,y=0,width=nil,height=nil,dx=0,dy=0,font=love.graphics.newFont( 12 ),color={r=255,g=255,b=255,a=255},hcolor={r=255,g=255,b=0,a=255}}
  self.counter=0
end
